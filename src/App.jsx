...
//       <><NavFooter /><SearchBar onSearch={handleSearch} /><div className="product-grid"> {/* Container for grid layout */}
...
//         </div>
//       ))}
//     </div><SellersForm onAddProduct={handleAddProduct} /><div className="basket">
//         <h2>Basket</h2>
//         {cart.map((item, index) => (
//           <div key={index}>
